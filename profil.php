...
try {
    ...
    // 2. STATISTIQUES DYNAMIQUES ALIGNÉES SUR L'ENUM DE IMAGE_5BF024.PNG
    ...
    try {
        ...
        // Reste à 0 si la table notifications n'est pas encore créée ou accessible
    }
...
<div class="container-xl px-3 py-3">
    <!--retour-->
    <div class="mb-3">
        <a href="index.php" class="text-decoration-none text-dark d-flex align-items-center gap-1"><i class="bi bi-arrow-left"></i> Retour</a>
    </div>
    ...
    <div class="card-custom">
        <div class="row align-items-center g-3 text-center text-sm-start">
            ...
            <div class="col-12 col-sm-grow flex-sm-grow-1">
                ...
                <div class="row g-2 text-muted text-start" style="font-size: 0.8rem;">
                    <div class="col-12 col-md-4 text-center text-sm-start text-truncate"><i class="bi bi-envelope me-1 text-success"></i><?= htmlspecialchars($user['email'] ?? 'Non renseigné') ?></div>
                    <div class="col-12 col-md-4 text-center text-sm-start"><i class="bi bi-telephone me-1 text-success"></i><?= htmlspecialchars($user['phone'] ?? '+221 -- --- -- --') ?></div>
                    <div class="col-12 col-md-4 text-center text-sm-start"><i class="bi bi-geo-alt me-1 text-success"></i>Sénégal</div>
                </div>
            </div>
            <div class="col-12 col-sm-auto ms-sm-auto">
                <a href="edit_profile.php" class="btn btn-success fw-semibold px-3 py-2 rounded-3 d-flex align-items-center gap-1">
    ...
    <!-- ZONE DES COMPTEURS (Synchronisés avec la base de données) -->
    ...
    <!-- GRILLE DE DEUX COLONNES FLUIDES -->
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="card-custom">
                ...
                <button class="btn btn-custom-outline w-100 mt-3"><i class="bi bi-pencil me-1"></i> Modifier les détails</button>
            </div>
            ...
            <div class="assistance-card mt-3 d-flex flex-column flex-sm-row align-items-center justify-content-between text-center text-sm-start gap-3">
                <div class="d-flex flex-column flex-sm-row align-items-center gap-2">
                    <div class="fs-3 text-white bg-white bg-opacity-10 rounded-circle px-3 py-1 border border-light-subtle"><i class="bi bi-headset"></i></div>
                    <div>
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="card-custom mt-3">
                ...
                <div>
                    ...
                    <div class="info-row border-bottom py-2"><span><i class="bi bi-envelope me-2 text-muted"></i>Notifications email</span><div class="form-check form-switch m-0"><input class="form-check-input" type="checkbox" checked></div></div>
                </div>
            </div>
        </div>
    ...
    <!-- BOUTON DECONNEXION -->
    <div class="my-4">
        <a href="../auth/logout.php" class="btn btn-danger w-100 py-2 fw-semibold rounded-3 d-flex align-items-center justify-content-center gap-2" onclick="return confirm('Voulez-vous vous déconnecter ?');">
...
<nav class="navbar bottom-nav fixed-bottom py-2 d-md-none">
    <div class="container-fluid d-flex justify-content-around">
        <a href="index.php" class="nav-link-custom"><i class="bi bi-house mb-1" style="font-size: 1.1rem;"></i>Accueil</a>
        ...
        <a href="notifications.php" class="nav-link-custom position-relative">
            <i class="bi bi-bell mb-1" style="font-size: 1.1rem;"></i>
            <?php if ($unread_notifications > 0): ?>
                <span class="position-absolute top-0 start-50 translate-middle badge rounded-pill bg-danger" style="font-size:8px;">
